...
- [HybridStreamingPOI](../src/test/java/ReadTestHybridStreamingPOI.java) - 21677 to 22016 from 3 samples
...
- OptimizedPOI: [Sample1](OptimizedPOI-JAVA1.8.png), [Sample2](OptimizedPOI-JAVA1.8_2.png) - Optimized POI using
  https://github.com/monitorjbl/excel-streaming-reader library is surprisingly fast compared to Apache POI itself.
  Though it has not been updated since 2021 and uses Apache POI 5.0.0 while current version is 5.5.1, I doubt there 
  would be any significant speed improvement when using latest version of POI.
- HybridStreamingPOI: [Sample1](HybridStreaming-JAVA1.8.png), [Memory](HybridStreamingMemory-JAVA1.8.png) -
  ...
  is speedup like 30% max - why it is not faster? when compared to excel-streaming-reader that is POI based and does only(?) some tweaking.
- XSSF_POI: [Sample1](XSSF-POI-JAVA1.8.png), [MemoryBefore](XSSF-MemoryBefore-JAVA1.8.png),
  ...
  This is really just for reference - huge memory spikes - looks like app managed to allocate up to 10GB RAM!
